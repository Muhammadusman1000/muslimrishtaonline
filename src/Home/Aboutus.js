...
const Aboutus = () => {
  return (
    <div className="w-full py-[100px] q">
      ...
      <div className="w-[70%] mx-auto mt-16 grid grid-cols-2">
        <div>
          ...
          <p className="mt-5">
            Muslim Rishta  Online in is one of the largest online Pakistan Matrimonial
            Site. Simple to use and exclusively online Premium matrimony
            services make us a differentiator amongst the matrimonial sites. We
            believe in providing a secure, easy to use and convenient
            matrimonial matchmaking experience to our members. Muslim Rishta  Online
            Pakistan's most oldest and most successful matchmaking service, has
            been trusted since 2011 by people all over the Pakistan to help them
            find their soulmates. Today, hundreds of thousands of people have
            met their life partners through our revolutionary matchmaking
            service and countless others have made some very special friends.
            Register with us for free to find your life partner. Our premium
            membership package ensures you are able to communicate with suitable
            members and Initiate marriage proposals.
          </p>
        </div>
        <div></div>
      </div>
