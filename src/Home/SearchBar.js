...
const SearchBar = () => {
  ...
  return (
    <div className="py-4 px-12 flex justify-center items-center bg-black opacity-70 shadow-md rounded-md relative -mt-[125px] z-20 font-poppins">
      <Formik
            ...
            <div className="grid grid-cols-1 md:grid-cols-6 gap-4 w-full">
              ...
              <div>
                ...
                >
                  ...
                  <option value="masters">Master's (MBA/MCS/MIT)</option>
                  <option value="graduationsimple">
                    Bachalore's (M.A/B.A/B.com)
                  </option>

                  <option value="graduationbs">
                    Bachalore's (BBA/BSC/etc)
                  </option>
